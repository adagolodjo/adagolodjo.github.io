...
<section class="section-card">
  ...
  <div class="timeline">
    <div class="timeline-item">
      <div style="font-weight: 600; color: var(--course-accent-ink); font-size: 1.1rem; margin-bottom: 0.5rem;">Chapitre 1 : Séries de Taylor et Applications</div>
      <div>
    ...
    <div class="timeline-item">
      <div style="font-weight: 600; color: var(--course-accent-ink); font-size: 1.1rem; margin-bottom: 0.5rem;">Chapitre 2 : Équations Différentielles Ordinaires</div>
      <div>
    ...
    <div class="timeline-item">
      <div style="font-weight: 600; color: var(--course-accent-ink); font-size: 1.1rem; margin-bottom: 0.5rem;">Chapitre 3 : Équations aux Dérivées Partielles</div>
      <div>
    ...
    <div class="timeline-item">
      <div style="font-weight: 600; color: var(--course-accent-ink); font-size: 1.1rem; margin-bottom: 0.5rem;">Chapitre 4 : Séries de Fourier</div>
      <div>
    ...
    <div class="timeline-item">
      <div style="font-weight: 600; color: var(--course-accent-ink); font-size: 1.1rem; margin-bottom: 0.5rem;">Chapitre 5 : Transformées de Fourier</div>
      <div>
    ...
    <div class="timeline-item">
      <div style="font-weight: 600; color: var(--course-accent-ink); font-size: 1.1rem; margin-bottom: 0.5rem;">Chapitre 6 : Applications en Ingénierie</div>
      <div>
...
<section class="section-card">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
    <div style="text-align: center; padding: 2rem 1rem; background: linear-gradient(135deg, var(--course-bg-soft), white); border-radius: var(--course-radius); box-shadow: var(--course-shadow);">
      <span style="font-size: 3rem; font-weight: 700; color: var(--course-accent-ink); display: block; margin-bottom: 0.5rem;">40%</span>
      <div style="font-weight: 600; color: var(--course-ink); margin-bottom: 0.5rem;">Devoir Surveillé (DS)</div>
      <div style="font-size: 0.9rem; color: #666;">Examen écrit sur les concepts théoriques et exercices d'application.</div>
    </div>
    
    <div style="text-align: center; padding: 2rem 1rem; background: linear-gradient(135deg, var(--course-bg-soft), white); border-radius: var(--course-radius); box-shadow: var(--course-shadow);">
      <span style="font-size: 3rem; font-weight: 700; color: var(--course-accent-ink); display: block; margin-bottom: 0.5rem;">35%</span>
      <div style="font-weight: 600; color: var(--course-ink); margin-bottom: 0.5rem;">Note de TP</div>
      <div style="font-size: 0.9rem; color: #666;">Travaux pratiques avec MATLAB/Python, projets numériques.</div>
    </div>
    
    <div style="text-align: center; padding: 2rem 1rem; background: linear-gradient(135deg, var(--course-bg-soft), white); border-radius: var(--course-radius); box-shadow: var(--course-shadow);">
      <span style="font-size: 3rem; font-weight: 700; color: var(--course-accent-ink); display: block; margin-bottom: 0.5rem;">25%</span>
      <div style="font-weight: 600; color: var(--course-ink); margin-bottom: 0.5rem;">Note de Classe</div>
