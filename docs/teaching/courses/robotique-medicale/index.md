...
<section class="section-card">
  ...
  <div class="timeline">
    <div class="timeline-item">
      <div style="font-weight: 600; color: var(--course-accent-ink); font-size: 1.1rem; margin-bottom: 0.5rem;">Module 1 : Introduction à la robotique médicale</div>
      <div>
    ...
    <div class="timeline-item">
      <div style="font-weight: 600; color: var(--course-accent-ink); font-size: 1.1rem; margin-bottom: 0.5rem;">Module 2 : Robotique chirurgicale</div>
      <div>
    ...
    <div class="timeline-item">
      <div style="font-weight: 600; color: var(--course-accent-ink); font-size: 1.1rem; margin-bottom: 0.5rem;">Module 3 : Robots de rééducation</div>
      <div>
    ...
    <div class="timeline-item">
      <div style="font-weight: 600; color: var(--course-accent-ink); font-size: 1.1rem; margin-bottom: 0.5rem;">Module 4 : IA et robotique médicale</div>
      <div>
    ...
    <div class="timeline-item">
      <div style="font-weight: 600; color: var(--course-accent-ink); font-size: 1.1rem; margin-bottom: 0.5rem;">Module 5 : Projet pratique</div>
      <div>
...
<section class="section-card">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
    <div style="text-align: center; padding: 2rem 1rem; background: linear-gradient(135deg, var(--course-bg-soft), white); border-radius: var(--course-radius); box-shadow: var(--course-shadow);">
      <span style="font-size: 3rem; font-weight: 700; color: var(--course-accent-ink); display: block; margin-bottom: 0.5rem;">60%</span>
      <div style="font-weight: 600; color: var(--course-ink); margin-bottom: 0.5rem;">Note de rapport</div>
