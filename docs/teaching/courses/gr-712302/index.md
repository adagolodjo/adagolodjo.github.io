...
<div class="course-hero">
  <div class="course-hero-content">
    <h1>{% include ph.html name="desktop" %} GR-712302 Programmation</h1>
    ...
    <div class="hero-badges">
      ...
      <span class="hero-badge">{% include ph.html name="timer" %} 20h TP</span>
      <span class="hero-badge">{% include ph.html name="target" %} Programmation avancée</span>
...
<section id="ressources" class="section-card">
  ...
  <div class="resources-grid">
    ...
    <div class="resource-card">
      <div class="resource-icon">{% include ph.html name="rocket-launch" %}</div>
